  ...
  return (
    <>
      ...
      <motion.aside
        initial={false}
        animate={{
          width: isExpanded || isMobileOpen ? 240 : 72,
          x: 0,
        }}
        onMouseEnter={() => setIsExpanded(true)}
        onMouseLeave={() => setIsExpanded(false)}
        className={`fixed left-0 top-0 h-screen bg-white border-r border-gray-200 shadow-sm z-50 transition-all duration-200 ${
      ...
      >
          ...
          {navItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {showBadge && (isExpanded || isMobileOpen) && (
                  <motion.span
        ...
        <div className="absolute bottom-0 w-full border-t border-gray-200 bg-white p-4">
          ...
          >
            ...
            <AnimatePresence>
              {(isExpanded || isMobileOpen) && userData && (
                <motion.div
                  initial={{ opacity: 0, x: -10 }}
                  animate={{ opacity: 1, x: 0 }}
                  exit={{ opacity: 0, x: -10 }}
